...
<head>
    ...
    <title>Tokoku - Admin Input Produk</title>
    <!-- Bootstrap 5 CSS -->
...
<div class="form-container">
    ...
    <div class="form-header">
        ...
        <p>Lengkapi form di bawah untuk menambahkan produk baru ke katalog</p>
    </div>
    ...
    <div class="form-body">
        <form id="formProduk" action="#" method="post">
            ...
            <div class="mb-4">
                <label class="form-label">
                    <i class="ti ti-tag"></i> Nama Produk
                    <span class="required-star">*</span>
                </label>
                <input type="text" class="form-control" id="namaProduk" placeholder="Contoh: Laptop, PC Desktop, PC All-in-One, dan komputer server." required>
            </div>

            <!-- Harga -->
            <div class="mb-4">
                <label class="form-label">
                    <i class="ti ti-currency-dollar"></i> Harga
                    <span class="required-star">*</span>
                </label>
                <input type="text" class="form-control" id="harga" placeholder="Rp 0" value="Rp Masukkan nominal harga" onfocus="if(this.value === 'Rp ') this.value=''" oninput="formatRupiah(this)">
            ...
            <div class="mb-4">
                <label class="form-label">
                    <i class="ti ti-article"></i> Detail Produk
                </label>
                <textarea class="form-control" id="detail" rows="3" placeholder="Deskripsikan produk secara lengkap, material, keunggulan, dll..."></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" class="form-control" id="stok" placeholder="Jumlah stok tersedia" value="0" min="0" required>
                <small class="text-muted">Satuan dalam pcs / unit</small>
            </div>

<!-- ==================== UPLOAD GAMBAR MULTIPLE ==================== -->
<div class="mb-3">
    <label class="form-label">
        <i class="ti ti-photo"></i> Upload Gambar Produk 
        <span class="text-muted">(Bisa banyak)</span>
    </label>
    
    <div class="image-preview-area" id="uploadArea">
        <input type="file" id="images" name="images[]" multiple accept="image/*" style="display: none;">
        <i class="ti ti-cloud-upload" style="font-size: 42px; color: #2c6e9e; opacity: 0.7;"></i>
        <p class="mt-2 mb-1 fw-medium">Klik untuk memilih gambar produk</p>
        <small class="text-muted">PNG, JPG, JPEG, WEBP - Maksimal 10 gambar</small>
    </div>

    <!-- Preview Area -->
    <div id="previewGrid" class="image-preview-grid mt-3"></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Reset saat tombol Batal
    const btnBatal = document.getElementById('btnBatal');
    if (btnBatal) {
        btnBatal.addEventListener('click', function() {
            if (confirm('Batalkan input?')) {
...
// Reset preview saat tombol Batal diklik (tambahkan di event btnBatal yang sudah ada)
document.getElementById('btnBatal').addEventListener('click', function() {
    if (confirm('Batalkan input? Semua data yang belum disimpan akan hilang.')) {
        document.getElementById('formProduk').reset();
        previewGrid.innerHTML = '';
        selectedFiles = [];
        // ... kode reset lain yang sudah ada
    }
});
</script>
